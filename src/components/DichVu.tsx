...
const products = [
  {
    ...
    name: 'Rip Faq',
    href: '/Login',
    imageSrc: 'https://i.imgur.com/f6meO8u.jpg',
  ...
  },
  {
    ...
    href: '/Login',
    imageSrc: 'https://i.imgur.com/SsPun24.jpg',
    imageAlt: "Front of men's Basic Tee in black.",
    price: '30-500000',
    color: 'Auto Xử Lý',
  },
  {
    ...
    name: 'Iban Be',
    href: '/Login',
    imageSrc: 'https://i.imgur.com/E0lXQgw.jpg',
    imageAlt: "Front of men's Basic Tee in black.",
    price: '50000',
    color: 'Không Trùng Private',
  },
  {
    id: 4,
    name: 'Iban De',
    href: '/Login',
    imageSrc: 'https://i.imgur.com/zEHfUkZ.jpg',
    imageAlt: "Front of men's Basic Tee in black.",
    price: '50000',
    color: 'Không Trùng Private DE',
  },
  {
    id: 5,
    name: 'Thuê Group Đấu Giá',
    href: '/Login',
    imageSrc: 'https://i.imgur.com/6jgHVv6.jpg',
    imageAlt: "Front of men's Basic Tee in black.",
    price: '200000-max',
    color: 'Group https://t.me/scanads0',
  },
  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        <h2 className="text-2xl font-bold tracking-tight text-gray-900">Dịch Vụ</h2>
