...
const products = [
  {
    ...
    name: 'HotMail Trust',
    href: '/Login',
    imageSrc: 'https://i.imgur.com/POUl8Yz.jpg',
  ...
  },
  {
    ...
    name: 'Gmail New',
    href: '/Login',
    imageSrc: 'https://i.imgur.com/vBrOMUX.png',
    imageAlt: "Front of men's Basic Tee in black.",
    price: '3000d',
    color: 'Bao Hành 24h',
  },
  {
    ...
    name: 'Outlook New',
    href: '/Login',
    imageSrc: 'https://i.imgur.com/t8wxOv8.png',
    imageAlt: "Front of men's Basic Tee in black.",
    price: '15d',
    color: 'Ngâm 24h ngày',
  },
  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        <h2 className="text-2xl font-bold tracking-tight text-gray-900">Gian hàng email</h2>
